    ...
    <div class="container p-2">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="card card-body">
                    <?php if(isset($Alertado2020) == true) {
                        echo "<img src='imagenes/2309codoacodo.jpeg' alt='Logo Codo a Codo' width='150'>";
                    }else{
                        echo "<img src='imagenes/2309codoacodo.jpeg' alt='Logo Codo a Codo' width='300'>";
                    }
                    ?>
            ...
            if ($consu=="ESPERANDO"){
                ...
                if ($vOK==1){
                $descriptor = "Solicitud ".str_pad($vIdSuscripcion, 7, "0", STR_PAD_LEFT)." Cuota Septiembre 2023 (".str_pad($vCuota, 3, "0", STR_PAD_LEFT).")|N°Sorteo ".str_pad($vNroSorteo, 3, "0", STR_PAD_LEFT)." (".$vApellido." ".$vNombres.")";
		...
		<legend><b>Datos del Cliente</b></legend>";  
                ...
                echo "MONTO A PAGAR2: <b>$".$vPesos.".- </b>N°Cuota Diciembre: <b>".$vCuota."</b>";
		...
		<legend><b>Datos del Cliente</b></legend>";  
                ...
                if ($vEndozo==0){    
                    ...
                    //Primer Endozo
                        ...
                        if ($vEstadoPago==0){
                        $descriptor = "CtaEndoso ".str_pad($vIdSuscripcion, 7, "0", STR_PAD_LEFT)." Cuota Septiembre 2023 (".str_pad($vCuota, 3, "0", STR_PAD_LEFT).")|N°Sorteo ".str_pad($vNroSorteo, 3, "0", STR_PAD_LEFT)." (".$vApellido." ".$vNombres.")";
                                            // SDK de Mercado Pago
                        require __DIR__ .  '/vendor/autoload.php';
